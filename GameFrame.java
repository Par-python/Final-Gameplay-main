...
public class GameFrame extends JFrame {
    ...
    // Show the GameCanvas screen first
    contentPane.setLayout(new BorderLayout()); // Needed to display full-size JComponent
    contentPane.add(gc, BorderLayout.CENTER);
    gc.start(); // Start GameCanvas
    this.revalidate();
    this.repaint();

    // Wait for the player to press "Ready" in the GUI (done inside GameCanvas)
    gc.setOnReady(() -> {
        // This block runs *after* player completes intro setup
